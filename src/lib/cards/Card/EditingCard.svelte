...
<Card {item} {...rest} isEditing={true} bind:ref>
	...
	{#snippet controls()}
		...
		<div
			class=" absolute -bottom-3 z-50 hidden w-full items-center justify-center text-xs group-focus-within:inline-flex group-hover:inline-flex"
		>
			<div
